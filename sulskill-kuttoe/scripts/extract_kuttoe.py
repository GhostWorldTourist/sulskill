...
def main():
    ...
    mods, used = {}, set()
    # Recursive: the mods may sit loose in Mods, in a manager's deployment
    # subfolder, or in a folder the player unzipped. All three are normal.
    for path in gate.find_mod_files('[[]Kuttoe[]] *.ts4script'):
