...
STBL = 0x220557DA
PATCH_DATE = datetime.datetime(2026, 8, 5).timestamp()   # game patched 1.126.73 -> .78
...
json.dump(report, open(os.path.join(HERE, 'report.json'), 'w', encoding='utf-8'), indent=1)
print("\n=== wrote report.json ===")
